...
public class Loader {
	...
	public RawModel loadToVAO(float[]pos, int dimensions){
		int vaoID = createVAO();
		this.storeDataInAttributeList(0, dimensions, pos);
		unbindVAO();
	...
	public int loadTexture(String fileName) {
		...
		try {
			...
			//change the -1 depending on how aggresive u want mipmapping
